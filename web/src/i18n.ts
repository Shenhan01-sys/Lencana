...
export const DICTIONARIES: Record<Lang, TranslationDictionary> = {
  en: {
    ...
    hero: {
      ...
      subtitle:
        'AI agents evaluate your practical essays with on-chain rubrics. Your achievements are minted as Soulbound Open Badges 3.0 on BNB Smart Chain.',
  ...
  id: {
    ...
    hero: {
      ...
      subtitle:
        'Agen AI mengevaluasi esai praktis Anda dengan rubrik on-chain transparan. Capaian Anda dicetak sebagai Open Badges 3.0 Soulbound di BNB Smart Chain.',

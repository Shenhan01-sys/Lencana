 ...
 *
 * Cara pakai (butuh anvil fork 97 + kontrak ter-deploy + data contoh):
 *   anvil --fork-url https://bsc-testnet.publicnode.com --chain-id 97 --silent &
 ...
 *   npm run probe
 *
 * Alamat yang dibaca bisa dilewatkan lewat environment; kalau tidak ada, skrip memakai
 * address default Anvil yang sama dengan yang dipakai skrip deploy.
 */
...
async function main() {
  ...
  console.log(failures === 0 ? '\nPROBE HIJAU' : `\nPROBE MERAH: ${failures} pemeriksaan gagal`)
